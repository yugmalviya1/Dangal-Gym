...
export default function FloatingSocials() {
  return (
    <div className="fixed bottom-4 sm:bottom-8 right-4 sm:right-8 z-50 flex flex-col gap-4">
      ...
      <a
        href="https://wa.me/919977437487"
        target="_blank"
        rel="noopener noreferrer"
        className="w-14 h-14 rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-all duration-300 bg-[#25D366] text-white hover:shadow-[#25D366]/50 hover:shadow-2xl"
        aria-label="WhatsApp"
      >
        <svg
